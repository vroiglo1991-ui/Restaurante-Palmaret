...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const I18N = {
    es: {
      ...
      heroTitle: 'El mejor <em>tercer tiempo</em> de Valencia.',
      heroSub: 'Gastronomía mediterránea · Arrocería · Almuerzos',
      heroDesc: 'El punto de encuentro donde cada momento se celebra con sabor.',
    ...
    en: {
      ...
      heroTitle: 'The best <em>third time</em> in Valencia.',
      heroSub: 'Mediterranean Gastronomy · Rice House · Lunches',
      heroDesc: 'The meeting point where every moment is celebrated with flavor.',
    ...
    va: {
      ...
      heroTitle: 'El millor <em>tercer temps</em> de València.',
      heroSub: 'Gastronomia mediterrània · Arrosseria · Esmorzars',
      heroDesc: 'El punt de trobada on cada moment es celebra amb sabor.',
