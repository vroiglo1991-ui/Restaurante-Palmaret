...
/* ── JSON-LD / Schema (en head, no extraido) ── */
    ...
    const I18N = {
      ...
      va: {
        ...
        featuredDescs: ['Recepta tradicional valenciana cuinada amb llenya de taronger.', '', 'La nostra reinterpretació del clàssic amb orxata de xufa valenciana, mascarpone i fartons torrats.', 'Pa brioix caramel·litzat, crema anglesa i gelat artesà d\'orxata d\'Alboraia.', 'Tonyina del Mediterrani, alvocat cremós, ikura, oli de sèsam i wasabi. Servit fred sobre base de gingebre.', 'Carxofa de la terreta rostida en flor, oli de tòfona negra i sal de pernil ibèric. L\'elegància del producte de proximitat.', 'Recepta pròpia d\'Esteve. Creïlla, carlota, pésols i maionesa artesana. La referència del tapeig valencià.'],
    ...
    const MENU_GLOSSARY = {
      en: [
        ...
        ['Bocadillo + bebida + café', 'Sandwich + drink + coffee'],
      ...
      va: [
        ...
        ['Bocadillo + bebida + café', 'Entrepà + beguda + cafè'],
